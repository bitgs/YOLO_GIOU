...
from utils.layer_utils import conv2d, darknet53_body, yolo_block, upsample_layer, inception_resnet_v2_base
...
# =============================================================================
        with slim.arg_scope([slim.conv2d],
            ...
            with tf.variable_scope('InceptionResnetV2', [inputs],reuse=reuse) as scope:
                route_1, route_2, route_3 = inception_resnet_v2_base(inputs, scope=scope)
