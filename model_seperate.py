        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm], reuse=reuse):
            with slim.arg_scope([slim.conv2d], 
                ...
                with tf.variable_scope('yolov3_head'):
                    ...
                    _, net_obj_class = yolo_block(net, 128)
                    feature_map_1_obj_class = slim.conv2d(net_obj_class, 3 * (1 + self.class_num), 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    _, net_location = yolo_block(net, 64)
                    feature_map_1_location = slim.conv2d(net_location, 3 * 4, 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    feature_map_1_obj_class_list = tf.split(feature_map_1_obj_class, 3, axis=3)
                    feature_map_1_location_list  = tf.split(feature_map_1_location, 3, axis=3)
                    feature_map_1 = tf.concat([feature_map_1_location_list[0],
                                               feature_map_1_obj_class_list[0],
                                               feature_map_1_location_list[1],
                                               feature_map_1_obj_class_list[1],
                                               feature_map_1_location_list[2],
                                               feature_map_1_obj_class_list[2]], axis=3)
                    ...
                    _, net_obj_class = yolo_block(net, 128)
                    feature_map_2_obj_class = slim.conv2d(net_obj_class, 3 * (1 + self.class_num), 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    _, net_location = yolo_block(net, 64)
                    feature_map_2_location = slim.conv2d(net_location, 3 * 4, 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    feature_map_2_obj_class_list = tf.split(feature_map_2_obj_class, 3, axis=3)
                    feature_map_2_location_list  = tf.split(feature_map_2_location, 3, axis=3)
                    feature_map_2 = tf.concat([feature_map_2_location_list[0],
                                               feature_map_2_obj_class_list[0],
                                               feature_map_2_location_list[1],
                                               feature_map_2_obj_class_list[1],
                                               feature_map_2_location_list[2],
                                               feature_map_2_obj_class_list[2]], axis=3)
                    ...
                    _, net = yolo_block(concat2, 128)
                    _, net_obj_class = yolo_block(net, 128)
                    feature_map_3_obj_class = slim.conv2d(net_obj_class, 3 * (1 + self.class_num), 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    _, net_location = yolo_block(net, 64)
                    feature_map_3_location = slim.conv2d(net_location, 3 * 4, 1,
                                                stride=1, normalizer_fn=None,
                                                activation_fn=None, biases_initializer=tf.zeros_initializer())
                    feature_map_3_obj_class_list = tf.split(feature_map_3_obj_class, 3, axis=3)
                    feature_map_3_location_list  = tf.split(feature_map_3_location, 3, axis=3)
                    feature_map_3 = tf.concat([feature_map_3_location_list[0],
                                               feature_map_3_obj_class_list[0],
                                               feature_map_3_location_list[1],
                                               feature_map_3_obj_class_list[1],
                                               feature_map_3_location_list[2],
                                               feature_map_3_obj_class_list[2]], axis=3)
