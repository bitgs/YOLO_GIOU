...
restore_path = './data/darknet_weights_trained_by_author/Epoch_32_step_91046_mAP_0.8754_loss_2.2147_lr_3e-05'#'/home/yuan/Downloads/inception_resnet_v2_2016_08_30.ckpt'  # The path of the weights to restore.
...
anchor_path = './data/coco_anchors.txt'  # The path of the anchor txt file.
...
pw_boundaries = [25, 35, 40]  # epoch based boundaries
pw_values = [learning_rate_init, 1e-4, 5e-5, 1e-5]
...
restore_include = ['yolov3/darknet53_body/']
restore_exclude = ['yolov3/yolov3_head']#['yolov3/yolov3_head/Conv_14', 'yolov3/yolov3_head/Conv_6', 'yolov3/yolov3_head/Conv_22']
