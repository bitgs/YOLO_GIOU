...
with tf.variable_scope('yolov3'):
    ...
    net1,net2,net3 = pred_feature_maps[3], pred_feature_maps[4], pred_feature_maps[5]
    pred_feature_maps = pred_feature_maps[0:3]
...
with tf.Session() as sess:
    ...
    __box_loss_scale, __label_target, _valid_true_boxes, _image, _net1, _net2, _net3 = sess.run(
        [y_true, loss, pred_feature_maps, x_y_offset, pred_boxes, pred_conf_logits, pred_prob_logits, 
         ...
         box_loss_scale, label_target, valid_true_boxes, image, net1, net2, net3],
        feed_dict={is_training: True})
print(_net1.shape)
print(_net2.shape)
print(_net3.shape)
    
test_y_true = __y_true
test_x = test_y_true[0][0,:,:,:,0]
test_y = test_y_true[0][0,:,:,:,1]
test_w = test_y_true[0][0,:,:,:,2]
test_h = test_y_true[0][0,:,:,:,3]
test_mix = test_y_true[0][0,:,:,:,-1]
