...
class yolov3(object):
    ...
    def forward_body(self, image, image_half, image_quar, is_training=False, reuse=tf.AUTO_REUSE):
        # the input img_size, form: [height, weight]
        # it will be used later
        self.img_size = tf.shape(image)[1:3]
        ...
        with slim.arg_scope([slim.conv2d], 
            ...
            with tf.variable_scope('darknet53_body', reuse=reuse):
                _, _, route_1 = darknet53_body(image)
                _, _, route_2 = darknet53_body(image_half)
                _, _, route_3 = darknet53_body(image_quar)
